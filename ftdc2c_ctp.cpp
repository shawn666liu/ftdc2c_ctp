...
FTDC2C_API void MYDECL TdSubscribePrivateTopic(void* trader, THOST_TE_RESUME_TYPE nResumeType, int nSeqNo)
{
    (static_cast<Trader*>(trader))->RawApi->SubscribePrivateTopic(nResumeType, nSeqNo);
}
...
FTDC2C_API int MYDECL TdReqGenSMSCode(void* trader, const CThostFtdcReqGenSMSCodeField* pReqGenSMSCode, int nRequestID)
{
    return (static_cast<Trader*>(trader))->RawApi->ReqGenSMSCode((CThostFtdcReqGenSMSCodeField*) pReqGenSMSCode, nRequestID);
}

FTDC2C_API int MYDECL TdReqSpdApply(void* trader, const CThostFtdcInputSpdApplyField* pInputSpdApply, int nRequestID)
{
    return (static_cast<Trader*>(trader))->RawApi->ReqSpdApply((CThostFtdcInputSpdApplyField*) pInputSpdApply, nRequestID);
}

FTDC2C_API int MYDECL TdReqSpdApplyAction(void* trader, const CThostFtdcInputSpdApplyActionField* pInputSpdApplyAction, int nRequestID)
{
    return (static_cast<Trader*>(trader))->RawApi->ReqSpdApplyAction((CThostFtdcInputSpdApplyActionField*) pInputSpdApplyAction, nRequestID);
}

FTDC2C_API int MYDECL TdReqQrySpdApply(void* trader, const CThostFtdcQrySpdApplyField* pQrySpdApply, int nRequestID)
{
    return (static_cast<Trader*>(trader))->RawApi->ReqQrySpdApply((CThostFtdcQrySpdApplyField*) pQrySpdApply, nRequestID);
}

FTDC2C_API int MYDECL TdReqHedgeCfm(void* trader, const CThostFtdcInputHedgeCfmField* pInputHedgeCfm, int nRequestID)
{
    return (static_cast<Trader*>(trader))->RawApi->ReqHedgeCfm((CThostFtdcInputHedgeCfmField*) pInputHedgeCfm, nRequestID);
}

FTDC2C_API int MYDECL TdReqHedgeCfmAction(void* trader, const CThostFtdcInputHedgeCfmActionField* pInputHedgeCfmAction, int nRequestID)
{
    return (static_cast<Trader*>(trader))->RawApi->ReqHedgeCfmAction((CThostFtdcInputHedgeCfmActionField*) pInputHedgeCfmAction, nRequestID);
}

FTDC2C_API int MYDECL TdReqQryHedgeCfm(void* trader, const CThostFtdcQryHedgeCfmField* pQryHedgeCfm, int nRequestID)
{
    return (static_cast<Trader*>(trader))->RawApi->ReqQryHedgeCfm((CThostFtdcQryHedgeCfmField*) pQryHedgeCfm, nRequestID);
}
